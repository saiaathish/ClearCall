...
const templates: readonly Template[] = [
  {
    ...
    educatorBodies: [
      "Force and control together. Neither one alone sells the colour.",
      "Start with contact height, then ask whether the player could still withdraw.",
      "If the follow-through rides up after the ball is gone, you're in red territory.",
      "Same challenge shape, different force story. That's the useful comparison.",
    ],
    refereeBodies: [
      ...
      "If the attacker stays upright and the contact stays low, I'm staying yellow.",
  ...
  },
  {
    ...
    educatorBodies: [
      ...
      "Separate make-the-body-bigger from an arm that simply can't move in time.",
    ],
    refereeBodies: [
  ...
  },
  {
    ...
    educatorBodies: [
      ...
      "Distance alone doesn't answer the card colour.",
  ...
  },
  {
    ...
    description: (level, beat) =>
      `Advantage puzzle in ${level}, ${beat}. The referee signals advantage after a foul, but the next action doesn't create a clear attacking benefit. Decide whether the window is still open.`,
    originalDecision: "Play continued",
    educatorBodies: [
      "The signal isn't a life sentence. Only the realized benefit is.",
      "If pressure is immediate, bring it back without apology.",
      "Hopeful signal vs actual advantage. Different things.",
    ...
    refereeBodies: [
      ...
      "Under that press I'm not waiting for a miracle.",
    ],
  },
  {
    category: "Simulation",
    ...
    educatorBodies: [
      ...
      "Name the contact before you name the theatre.",
    ...
    refereeBodies: [
      ...
      "The fall is bigger than the contact, I'm not giving a penalty.",
      "Legal challenge plus embellishment: play on, maybe a word.",
      "If I can't sell the foul, I'm not inventing simulation either.",
    ],
  },
  {
    ...
    refereeBodies: [
      ...
      "Low pressure doesn't erase a clear restriction offence.",
    ],
  },
];
  ...
  for (let index = 0; index < needed; index += 1) {
    ...
    cases.push(
      buildCase({
        ...
        expertExplanation: `${template.educatorBodies[index % template.educatorBodies.length]} Demo take only. Get a real assessor on anything close.`,
