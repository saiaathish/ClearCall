...
export const extraCases: readonly OfficiatingCase[] = [
  buildCase({
    ...
    educatorBody: "Ankle height alone doesn't decide the card. Pair it with control and whether the sole was driven through the ball.",
    refereeBody: "I'd sell the yellow loudly and record stud angle for the assessor notes.",
  ...
  buildCase({
    ...
    educatorBody: "Watch for the second beat after the miss, that's where force and intent separate from a clumsy miss.",
    refereeBody: "If I'm not sure about the downward pressure, I stay on yellow and write the doubt clearly.",
  ...
  buildCase({
    ...
    educatorBody: "Late isn't automatically yellow. Ask whether the force endangered the opponent or only interrupted play.",
  ...
  buildCase({
    ...
    educatorBody: "Sequence matters. Legal chest contact followed by an unavoidable brush isn't the same as a raised-arm block.",
  ...
  buildCase({
    ...
    refereeBody: "Red card, free kick, manage the benches, don't negotiate the colour on the field.",
  ...
  buildCase({
    ...
    educatorBody: "Don't ignore the keeper. An obvious chance requires a realistic path to goal, a rushing keeper can erase that.",
  ...
  buildCase({
    ...
    refereeBody: "I'd rather whistle early than invent a late bring-back after three seconds.",
  ...
  buildCase({
    ...
    educatorBody: "Ball first isn't a free pass. Judge the endangering contact that arrives on the follow-through.",
